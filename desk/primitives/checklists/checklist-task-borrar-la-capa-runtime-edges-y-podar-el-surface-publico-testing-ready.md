---
# checklist-xxx
id: checklist-task-borrar-la-capa-runtime-edges-y-podar-el-surface-publico-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-borrar-la-capa-runtime-edges-y-podar-el-surface-publico-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
