---
# checklist-xxx
id: checklist-task-retirar-modulos-sueltos-sin-importadores-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-retirar-modulos-sueltos-sin-importadores-ready-for-closeout
- condition-task-retirar-modulos-sueltos-sin-importadores-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
